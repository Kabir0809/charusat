                        ...
                        <div className="post-inner">
                          <div className="post-content">
                            ...
                            <ul>
                              ...
                              <li>
                              Mr. Kalpesh Patel, Assistant Engineer - Ext. No. 5107
                              </li>
                              <li>
                              Mr. Viral Patel, Assistant Engineer - Ext. No. 5107
                              </li>
                              <li>
                              Mr. Kamlesh Patel, Network Technician - Ext. No. 5107
                              </li>
                              <li>
                              Mr. Hardik Patel, Network Technician - Ext. No. 5107
                              </li>
                              <li>
                              Mr. Harsh Patel, Network Technician- Ext. No. 5107
                              </li>
                            </ul>
                          </div>
                        </div>
