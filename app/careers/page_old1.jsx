                          ...
                          <div className="post-content">
                            ...
                            <Container>
                              <Row className="p-2">
                                ...
                                <Col md={6}>
                                  <img src="./assets/files/Advertisement-careers/Advertisement-Apr-2025.png" alt="recruitment" 
                                  height="500px" 
                                  width="500px"
                                  style={{
                                    borderRadius: "12px",
                                ...
                                <Col md={4}>  
                                  <a
                                    ...
                                    href="./assets/files/Advertisement-careers/Final_Qualification_and_Experience_Criteria_(Academic_Non_Academic_Positions).pdf"
                                  >
