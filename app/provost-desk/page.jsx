...
import provost from "@/public/assets/images/People/user.png";
// const desc = [
          ...
          <div className="col-sm-3">
            <div className="about-left mt-1">
              ...
              <div style={{ textAlign: "center", marginTop: "10px" }}>
                ...
                <h5 className="fw-bold">Provost, CHARUSAT</h5>
              </div>
            </div>
          </div>
                ...
                <div className="post-inner">
                  <div className="post-content">
                    ...
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      ...
                      has been conceived by Shri Charotar Moti Sattavis Patidar
                      Kelavani Mandal to put India on global education map by
                      making Charotar – the Land of Sardar Patel, a Global
                      Education Hub. The University fosters an aspiration of
                      being a World Class University. It strives, initially, to
                      be in the league of Top 20 Universities at National Level.
                      <br />
                      <br />
                      The exceptional vision of the President, CHARUSAT and
                      Kelavani Mandal, Shri Surandrabhai Patel (fondly known as
                      Kaka) strengthened by institutional values of Honesty,
                      Integrity and transparency has enabled the university to
                      realize the ambitious goal by 2025.
                    </p>
                    <br />
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      I am honored and privileged to be a Member of CHARUSAT
                      Family during this very special time in its history. I
                      believe that in these challenging times, CHARUSAT
                      Fraternity needs to move forward together and succeed in
                      its mission of preparing the students for global
                      assignments by fostering attitude, building knowledge and
                      sharpening skills so as to create a talent pool best fit
                      not only for jobs but also for entrepreneurship with a
                      spirit of service to the society.
                    </p>
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      What distinguishes CHARUSAT from the rest of the
                      universities is how it implements the strategy to achieve
                      its goals. The strategy takes into consideration its own
                      vision, its past accomplishments, its strengths and
                      resources, and the challenges posed by the environment.
                      Primarily, CHARUSAT Framework for Excellence focuses on
                      the Core Performance Areas: Teaching, Learning and
                      Assessment; Research Development and Innovation; and
                      Extension and Community Services and Core Capacity
                      Dimensions like Good Governance, Infrastructure, Faculty
                      Competence, and Student Talent.
                    </p>
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      Student-centric curricula and Pedagogy at CHARUSAT focuses
                      on creating sustainable and conducive environment for
                      learning. To achieve this, all efforts at CHARUSAT, are
                      dedicated to inculcate active and experiential learning in
                      the courses and capitalize on the use of technology in
                      class.
                    </p>
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      Education at CHARUSAT accord with many opportunities
                      within and beyond the classroom to acquire knowledge, to
                      develop interests and inclinations, and to stretch the
                      potential, all within a nurturing and conducive learning
                      environment. To foster institutional cultural change,
                      emphasis is placed on learning, member engagement, faculty
                      involvement in the shared governance process, and
                      continual improvement.
                    </p>
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      It is also essential that university productivity and
                      research funding in different faculties is increased.
                      Along with remove sustainability, this will also enhance
                      the visibility of the university. s.
                    </p>
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      This will establish a dynamic research environment through
                      faculty involvement in graduate teaching and research, as
                      well as the expansion of graduate programs in
                      multidisciplinary fields
                    </p>
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      The Provost office will serve and support the faculty all
                      the times, reinforcing a culture of excellence, respect
                      and open communication in their efforts in the direction.
                    </p>
                    <p style={{ textAlign: "justify", lineHeight: "1.8rem" }}>
                      I look forward to your kind cooperation and support.
                    </p>
